...
| Text appearance, hover/menu placement, direct resizing, contrast/transparency/motion behavior | **Partial** | Implemented in SwiftUI/AppKit; deterministic mode/size/font/color/layout tests; focused visual comparison in [`design-qa.md`](../design-qa.md); hover reveal and delayed click-through collapse exercised in the running app with owner confirmation | VoiceOver, multi-display, and full accessibility acceptance matrix |
